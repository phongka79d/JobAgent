...
- README.md
- docs/tasks/task_5.md
- docs/plans/Plan_5.md (§5, §7.1)
- docs/plans/Master_plan.md (§3 stack, §11.2, §20)
...
- Mixed DNS answers fail closed entirely (no “prefer public” filtering).
...
- README.md
- docs/tasks/task_5.md
- docs/plans/Plan_5.md (§7.2, §7.3)
- docs/plans/Master_plan.md (§7.1, §7.4, §7.5, §8.2, §18.2)
...
## Key Implementation Decisions
- `JobSkill` wraps unchanged `SkillRef` with relationship confidence/evidence (Master §8.2 REQUIRES/PREFERS props); no SkillRef mutation.
...
- risk areas: majority threshold and nine-group inventory are an executable interpretation of Master §7.5 + §18.2; 02B owns persistence of `quality_reasons`
- next task readiness: can_review
