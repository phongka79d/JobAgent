...
_SYSTEM_PROMPT: Final[str] = (
    "You extract structured Job Description facts and explicit professional "
    "capabilities from JD text. Return only "
    ...
    "(3) every skill name is one atomic professional capability; clear source "
    "lists and alternatives become separate rows that may share "
    "evidence; "
    "(4) preserve punctuation inside a contiguous atomic label; "
    ...
    "capabilities listed in qualification enumerations. "
