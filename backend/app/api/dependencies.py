...
Production chat deps wire the three profile tools through
:func:`~app.tools.registry.production_registry` with request-scoped storage
and Neo4j driver from app lifespan state.
"""
...
def get_chat_agent_deps(request: Request) -> ChatAgentDeps:
    """Production chat deps: three profile tools, deferred model, SQLite path.
