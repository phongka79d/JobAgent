...
type DrawerController = Pick<CvManagerController, 'refresh' | 'select' | 'openDeleteDialog' | 'closeDeleteDialog' | 'confirmDelete'> & {close?: CvManagerController['close']; state: CvManagerViewState};

export type CvManagerDrawerProps = {
  isOpen: boolean;
  onOpenChange: (isOpen: boolean) => void;
  controller: DrawerController;
  onCvReprocess?: (attachmentId: string) => void;
...
export function CvManagerDrawer({isOpen, onOpenChange, controller, onCvReprocess, onActivateProfile, onRetryUpload, onDeleted}: CvManagerDrawerProps) {
