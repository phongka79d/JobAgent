...
export function TechnicalGraphPanel({resource}: TechnicalGraphPanelProps) {
  ...
  return (
    <VStack gap={2} width="100%" data-testid="jobagent-technical-graph">
      ...
      {snapshot ? (
        <VStack gap={2} width="100%">
          ...
          {model ? (
            <GraphVisualizationBoundary key={model.identity} resetKey={snapshot}>
